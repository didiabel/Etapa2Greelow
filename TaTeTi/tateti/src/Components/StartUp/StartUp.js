            ...
            <div className="startUpBox border rounded shadow-xl p-5">
              ...
              <div className="d-flex justify-content-center mt-5">
                <div className=" palabraStartUp text-center m-3">
                  <h1 className="palabraStartUp d-flex justify-content-around align-items-center">
                    {jugador1}
                  </h1>
                  <input
                    className={"m-2"}
                  ...
                  <h6
                    className={jugador1.length >= 10 ? "text-danger" : "d-none"}
                  >
                ...
                <div className="palabraStartUp text-center m-3">
                  <h1 className=" d-flex justify-content-around align-items-center">
                    {jugador2}
                  </h1>
                  <input
                    className={"m-2"}
                  ...
                  <h6
                    className={jugador2.length >= 10 ? "text-danger" : "d-none"}
                  >
                    (Debe ser menos de 10 letras)
                  </h6>
                </div>
